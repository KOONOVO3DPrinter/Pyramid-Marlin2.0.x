...
#define ID_X_MODE_RETURN					1

#define ID_X_MODE_FULL						2
#define ID_X_MODE_FULL_ARROW				3
#define ID_X_MODE_AUTO						4
#define ID_X_MODE_AUTO_ARROW				5
#define ID_X_MODE_DUPLICATION				6
#define ID_X_MODE_DUPLICATION_ARROW		7
#define ID_X_MODE_MIRROR					8
#define ID_X_MODE_MIRROR_ARROW			9
...
static void event_handler(lv_obj_t * obj, lv_event_t event)
{
	switch(obj->mks_obj_id)
	{
	    ...
	    if(event == LV_EVENT_CLICKED) {
			...
			lv_btn_set_style(buttonFullControl, LV_BTN_STYLE_REL, &tft_style_lable_sel_rel);
			lv_btn_set_style(buttonAutoPark, LV_BTN_STYLE_REL, &tft_style_lable_rel);
         		lv_btn_set_style(buttonDupli, LV_BTN_STYLE_REL, &tft_style_lable_rel);
         		lv_btn_set_style(buttonMirror, LV_BTN_STYLE_REL, &tft_style_lable_rel);
	    }
		break;
		case ID_X_MODE_FULL_ARROW:
	    if(event == LV_EVENT_CLICKED) {
	    ...
	    if(event == LV_EVENT_CLICKED) {
			...
			gcode.process_subcommands_now_P(PSTR("M500"));
			lv_btn_set_style(buttonFullControl, LV_BTN_STYLE_REL, &tft_style_lable_rel);
			lv_btn_set_style(buttonAutoPark, LV_BTN_STYLE_REL, &tft_style_lable_sel_rel);
         		lv_btn_set_style(buttonDupli, LV_BTN_STYLE_REL, &tft_style_lable_rel);
         		lv_btn_set_style(buttonMirror, LV_BTN_STYLE_REL, &tft_style_lable_rel);
	    }
		break;
		case ID_X_MODE_AUTO_ARROW:
	    if(event == LV_EVENT_CLICKED) {
	    ...
	    if(event == LV_EVENT_CLICKED) {
			...
			lv_btn_set_style(buttonFullControl, LV_BTN_STYLE_REL, &tft_style_lable_rel);
			lv_btn_set_style(buttonAutoPark, LV_BTN_STYLE_REL, &tft_style_lable_rel);
         		lv_btn_set_style(buttonDupli, LV_BTN_STYLE_REL, &tft_style_lable_sel_rel);
         		lv_btn_set_style(buttonMirror, LV_BTN_STYLE_REL, &tft_style_lable_rel);
	    }
		break;
		case ID_X_MODE_DUPLICATION_ARROW:
	    if(event == LV_EVENT_CLICKED) {
	    ...
	    if(event == LV_EVENT_CLICKED) {
			...
			lv_btn_set_style(buttonAutoPark, LV_BTN_STYLE_REL, &tft_style_lable_rel);
         		lv_btn_set_style(buttonDupli, LV_BTN_STYLE_REL, &tft_style_lable_rel);
         		lv_btn_set_style(buttonMirror, LV_BTN_STYLE_REL, &tft_style_lable_sel_rel);
	    }
		break;
		case ID_X_MODE_MIRROR_ARROW:
	    if(event == LV_EVENT_CLICKED) {
...
void lv_draw_x_mode(void)
{
	...
	lv_btn_set_style(buttonFullControl, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonFullControl, LV_BTN_STYLE_PR, &tft_style_lable_sel_pre);      /*Set the button's pressed style*/
	...
	lv_imgbtn_set_style(buttonFullControlNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonFullControlNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
	...
	lv_btn_set_style(buttonAutoPark, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonAutoPark, LV_BTN_STYLE_PR, &tft_style_lable_sel_pre);      /*Set the button's pressed style*/
	...
	lv_imgbtn_set_style(buttonAutoParkNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonAutoParkNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
	...
	lv_btn_set_style(buttonDupli, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonDupli, LV_BTN_STYLE_PR, &tft_style_lable_sel_pre);      /*Set the button's pressed style*/
	...
	lv_imgbtn_set_style(buttonDupliNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonDupliNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
	...
	lv_btn_set_style(buttonMirror, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonMirror, LV_BTN_STYLE_PR, &tft_style_lable_sel_pre);      /*Set the button's pressed style*/
	...
	lv_imgbtn_set_style(buttonMirrorNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonMirrorNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
	...
	lv_obj_set_pos(buttonBack,390,260);

...
void lv_draw_eeprom_settings(void)
{
	...
	lv_btn_set_style(buttonStore, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonStore, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
	...
	lv_imgbtn_set_style(buttonStoreNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonStoreNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
	...
	lv_btn_set_style(buttonRead, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonRead, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
	...
	lv_imgbtn_set_style(buttonReadNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonReadNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);
	...
	lv_btn_set_style(buttonRevert, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonRevert, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
	...
	lv_imgbtn_set_style(buttonRevertNarrow, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonRevertNarrow, LV_BTN_STATE_REL, &tft_style_lable_rel);

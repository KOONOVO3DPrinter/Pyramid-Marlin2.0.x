...
void disp_language_init()
{
	...
	switch(gCfgItems.language)
	{
		...
		case LANG_COMPLEX_CHINESE:
			...
			set_menu.Xmode=X_MODE_TEXT_T_CN;
            //set_menu.machine_para = MACHINE_PARA_T_CN;
            		set_menu.eepromSet = EEPROM_SETTINGS_T_CN;
			set_menu.eepromTitle = EEPROM_SETTINGS_TITLE_T_CN;
			set_menu.revert = EEPROM_SETTINGS_REVERT_T_CN;
			set_menu.revertTips =  EEPROM_REVERT_TIPS_T_CN;
			//
			...
			x_mode_menu.title=MODE_INDEX_T_CN;
			x_mode_menu.fullControl=FULL_CONTROL_T_CN;
			x_mode_menu.autoPark=AUTO_PARK_T_CN;
			x_mode_menu.duplication=DUPLICATION_T_CN;
			x_mode_menu.mirrored=MIRRORED_T_CN;

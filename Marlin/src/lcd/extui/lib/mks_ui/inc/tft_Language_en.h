...
#define MODE_INDEX_EN   	"IDEX Mode"
#define FULL_CONTROL_EN	"Full control mode"
#define AUTO_PARK_EN		"Auto park mode"
#define DUPLICATION_EN		"Duplication mode"
#define MIRRORED_EN		"Mirrored mode"

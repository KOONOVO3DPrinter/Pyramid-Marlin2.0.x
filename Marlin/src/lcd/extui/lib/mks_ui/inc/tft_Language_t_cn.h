...
#define MODE_INDEX_T_CN   "打印模式"
#define FULL_CONTROL_T_CN	"Full control mode"
#define AUTO_PARK_T_CN		"Auto park mode"
#define DUPLICATION_T_CN	"Duplication mode"
#define MIRRORED_T_CN		  "Mirrored mode"
#define EEPROM_SETTINGS_T_CN "Eeprom設置"
#define EEPROM_SETTINGS_TITLE_T_CN  "Eeprom设置"
#define EEPROM_SETTINGS_REVERT_T_CN "使用配置文件默认参数"
#define EEPROM_REVERT_TIPS_T_CN     "是否使用配置文件默认参数?"

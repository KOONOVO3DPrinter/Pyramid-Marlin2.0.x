...
#define MODE_INDEX_CN   "打印模式"
#define FULL_CONTROL_CN	"Full control mode"
#define AUTO_PARK_CN		"Auto park mode"
#define DUPLICATION_CN	"Duplication mode"
#define MIRRORED_CN		  "Mirrored mode"
#define EEPROM_SETTINGS_CN "Eeprom设置"
#define EEPROM_SETTINGS_TITLE_CN  "Eeprom设置"
#define EEPROM_SETTINGS_REVERT_CN "使用配置文件默认参数"
#define EEPROM_REVERT_TIPS_CN     "是否使用配置文件默认参数?"
